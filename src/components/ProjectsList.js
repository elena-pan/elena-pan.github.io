...
import covidConnectionsIcon from "../images/covid-connections-icon.png";

function ProjectsList() {

    const projects = [{name: "COVID Connections | Hack the North Project", description: "COVID Connections is an Android app that keeps track of COVID-19 cases and exposure in your 'circle'. Moreover, it notifies you when your connections are in need, so you can volunteer to help others with anything from groceries to snow shoveling.", image:covidConnectionsIcon, github:"https://github.com/elena-pan/COVID-Connections"},
                    {name: "Chef Pan | Personal Brand Web App", description: "This is the website that hosts my recipes and personal brand! It's a full-stack web app built using React and Flask, with MongoDB and GCP for data storage.", image:chefpanIcon, github:"https://github.com/elena-pan/ChefPan-Web-App", link:"https://elena-pan.github.io/heroku-loader/#/chefpan"},
                    {name: "FitSpire | Fitness Tracker", description: "FitSpire is a full-stack web app for exercise tracking, which sends daily fitness challenges. It's built using the MERN stack.", image:fitspireIcon, github:"https://github.com/elena-pan/fitspire", link:"https://elena-pan.github.io/heroku-loader/#/fitspire"},
                    {name: "Smart Garden", description: "Smart Garden is an automated plant management system that allows users to take care of their plant remotely via an Android app. It monitors environmental conditions and waters the plant remotely.", image:smartGardenIcon, github:"https://github.com/elena-pan/smart-garden"},
